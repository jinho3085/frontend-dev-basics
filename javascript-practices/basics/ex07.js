...
console.log("====[02] prototype.constructor 객체");
...
console.log("====[06] prototype 객체 속성 접근 - 속성");
...
console.log("====[12] Function.protype 객체의 속성 사용해보기");
console.log(math.toString.apply({name: '돌리'}), math.add.call(null, 10, 20));
